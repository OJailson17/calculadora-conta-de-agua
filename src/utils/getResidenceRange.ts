...
// Based on the consumption and residence category, return the range the consumption is in and which ranges already exceed
export const getResidenceRange = (
  ...
  // Go through the ranges object and return the first range that returns true. Then, save the previous ranges in an array
